...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-all ease-in-out duration-200",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow hover:bg-primary/90",
        other: "bg-other text-foreground shadow hover:bg-other/90",
        transparent: "bg-transparent border text-primary-foreground shadow",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-background bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
      ...
      size: {
        default:
          "h-9 py-4 px-6 sm:py-6 sm:px-8 hover:scale-[1.02] active:scale-[0.98]",
        sm: "h-8 rounded-full px-4 text-xs",
        lg: "h-10 rounded-md px-8",
        icon: "h-9 w-9 active:scale-50",
      },
    },
    defaultVariants: {
      variant: "default",
